...
class Receiver:
    ...
    def __init__(self, fc, preamble, config):
        ...
        if self.filter_type == Receiver.AVERAGE_FILTER:
            ...
            if config.filter_avg_window:
                self.window_size = config.filter_avg_window
        self.spb = config.spb
    ...
    def process(self, samples):
        ...
        try:
            ...
            offset = 0
            preamble_signal_start = 0
            print("Warning: Could not detect preamble")
#            raise PreambleDetectionError("Couldn't detect first one")
        ...
        if snr is not None and snr > 0.0:
            ...
            print("Warning: Could not estimate SNR")
